...
router.post('/lobby/:CallerFormID.:CallerBuildingID.:CallerUnitID.:CallerRoleID', function (req, res) {
...
router.get('/lobby/:CallerFormID.:CallerBuildingID.:CallerUnitID.:CallerRoleID', function (req, res) {
...
//______________________Lobby Select_____________________//
router.get('/lobby2/:buildingId.:CallerFormID.:CallerBuildingID.:CallerUnitID.:CallerRoleID', function (req, res) {
...
router.get('/members/:CallerFormID.:CallerBuildingID.:CallerUnitID.:CallerRoleID', function (req, res) {
...
router.get('/suppliers/:CallerFormID.:CallerBuildingID.:CallerUnitID.:CallerRoleID', function (req, res) {
